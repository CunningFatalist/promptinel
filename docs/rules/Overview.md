...
| [No Prompt Override Instructions](../rules/NoPromptInjectionOverride.md)            | `no-prompt-injection-override`        | `medium` | Detects common prompt-injection override phrases                             |
...
| [No Secret Exfiltration Intent](../rules/NoSecretExfiltrationIntent.md)             | `no-secret-exfiltration-intent`       | `high`   | Detects co-occurrence of secret targets and exfiltration actions             |
| [No Secret To Network Flow](../rules/NoSecretToNetworkFlow.md)                      | `no-secret-to-network-flow`           | `high`   | Detects secret-source to outbound-network exfiltration chains                |
...
| [No Tainted Placeholder Instructions](../rules/NoTaintedPlaceholderInstructions.md) | `no-tainted-placeholder-instructions` | `high`   | Detects tainted placeholders near override or capability language            |
